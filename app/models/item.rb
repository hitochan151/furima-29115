class Item < ApplicationRecord
  ...
  :prefecture_id, :day_id, :shopping_charge_id, :image, presence: true
  ...
  validates :category_id, :product_status_id, :day_id, 
  :prefecture_id,:shopping_charge_id, numericality: { other_than: 1 } 
