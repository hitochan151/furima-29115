...
ActiveRecord::Schema.define(version: 2021_01_15_032405) do
  ...
  create_table "destniations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchaser_id"], name: "index_destniations_on_purchaser_id"
  end
  ...
  add_foreign_key "destniations", "purchasers"
